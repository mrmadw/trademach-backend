...
SECRET_KEY = 'django-insecure-^)@9_=4q&fgdgklduqeqx)mtxry!i7a8ur&8#k9%76vnm$ts!!'
...
ROOT_URLCONF = 'trade_mach.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / "users/templates"],  # global templates folder
...
WSGI_APPLICATION = 'trade_mach.wsgi.application'
